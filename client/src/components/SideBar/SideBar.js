        ...
        <div className="sidebar-container">
            <div className="sidebar-buttons">
                ...
                <div className='film-svg-container'
                    onClick={() => { props.searchMovies({ type: "movie", active: props.activeSearch.type === "tv" ? props.activeSearch.active : !props.activeSearch.active }); props.setResult([props.search, 'movie']); props.history.push('/') }}>
                ...
                <div ref={tvButtonRef} className={`tv-svg-container ${returnCurrentPosition()}`}
                    onClick={() => { props.searchMovies({ type: "tv", active: props.activeSearch.type === "movie" ? props.activeSearch.active : !props.activeSearch.active }); props.setResult([props.search, 'tv']); props.history.push('/')}}>
                ...
                <div className='heart-svg-container'
                    onClick={() => {props.searchMovies({ type: "favorites" }); props.history.push('list')}}>
