        ...
        <div className="sidebar-container">
            <div className="sidebar-buttons">
                ...
                <div className='film-svg-container'
                    onClick={() => props.searchMovies({ type: "movie", active: props.activeSearch.type === "tv" ? props.activeSearch.active : !props.activeSearch.active })}>
                ...
                <div className={`tv-svg-container ${props.activeSearch.type === 'movie' ? 'before' : props.activeSearch.type === 'tv' ? '' : 'after' }`}
                    onClick={() => props.searchMovies({ type: "tv", active: props.activeSearch.type === "movie" ? props.activeSearch.active : !props.activeSearch.active })}>
